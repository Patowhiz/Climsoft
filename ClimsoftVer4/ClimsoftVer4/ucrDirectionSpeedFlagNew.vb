Public Class ucrDirectionSpeedFlagNew
    ...
    Public Sub SetTableNameAndDirectionSpeedFlagFields(strTableName As String, strDirectionFieldName As String, strSpeedFieldName As String, strFlagFieldName As String)
        'TODO SetTable in the ucrBasedatalink
    ...
    Public Overrides Sub UpdateValueChoices()
        If Not bFirstLoad Then
            ...
            ucrDirection.UpdateValueChoices()
            ucrSpeed.UpdateValueChoices()
            ucrFlag.UpdateValueChoices()
        End If
    End Sub
